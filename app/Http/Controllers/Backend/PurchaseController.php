...
class PurchaseController extends Controller
{
    ...
    {
        $purchases = Purchase::where('creator_role','admin')->where('created_by',Auth::guard('admin')->user()->id)->orderByDesc('id')->get();
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.purchase.edit', compact('purchase','products'));
    }
